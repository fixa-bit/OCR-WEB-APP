...
//   anchorElement.download = "xxxx.jpg";
//   anchorElement.click();
// }
...
//     //     sourcePath: widget.imagefilex.path,


//     //     );

//     // if (croppedfile != null) {
//     //   //jpg = croppedfile.readAsBytesSync();
//     //   //im.encodeJpg(brightenedImage);
//     //   jpg = croppedfile.readAsBytesSync();
//     //   widget.imagefilex = croppedfile;

//      //brightenedImage = im.decodeImage(await (croppedfile).readAsBytes());
//       //updateImage();
...
//     print(sizeInMb);
//     if (sizeInMb > 1.5){
//       print("File is greater thn 1.5 MB");
//         // This file is Longer the
//     }
//      else{
//       print("File is less thn 1.5 MB");
//         // This file is Longer the
//     }
...
//               builder: (context) => AlertDialog(
//                 //title: Text('Alert'),
//                 content:  Text('فائل کا سائز 1.5 MB سے زیادہ نہیں ہو سکتا۔',textDirection: TextDirection.rtl,
//               ),
...
//                   Text("فائل کا سائز 1.5 ایم بی سے زیادہ نہیں ہونا چاہئے۔",textDirection: TextDirection.rtl,style: TextStyle(
...
//                   Text("File Size Should not Exceed 1.5 MB  ",textDirection: TextDirection.ltr,
