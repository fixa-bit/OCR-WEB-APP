...
import '/image-3.3.0/lib/image.dart' as Library;
...
void main() {
  self.onMessage.listen((event) {
    ...
    if (arguments[0] == 0) {
      ...
      //   Library.Image.fromBytes(bytes:arguments[3], height:arguments[2], width:arguments[1],numChannels: 3),//Library.Channels.rgb),
      //   x:arguments[4],
      //   y:arguments[5],
      //   width:arguments[6],
      //   height:arguments[7],
