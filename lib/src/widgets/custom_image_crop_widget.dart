...
import '/src/calculators/calculate_crop_fit_params.dart';
import '/src/calculators/calculate_on_crop_params.dart';
import '/src/clippers/inverted_clipper.dart';
...
@override
  ...
  @override
  Future<Uint8List?> onCropImagex() async {
    if (_imageAsUIImage == null) {
      return null;
    }
    final imageWidth = _imageAsUIImage!.width;
